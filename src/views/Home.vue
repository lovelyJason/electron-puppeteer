    ...
    <el-tabs v-model="tab" type="card">
      ...
      <el-tab-pane label="使用步骤" name="third">
        <ul>
          ...
          <li>2.目前虽然支持添加多个案子，当前只支持提交第一个，因为涉及到多线程的问题，暂未开放</li>
        </ul>
      </el-tab-pane>
    </el-tabs>
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    async start () {
      ...
      const form = (this.tableData && this.tableData[0]) || {}
      ...
      const { code, msg, message } = await ipcRenderer.invoke('submit', formData)
