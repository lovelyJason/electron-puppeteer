<template>
  <div class="changelog">
    <div class="met-log-body col-xl-9 pl-md-5">
      <ul class="met-log-list list-unstyled pl-md-5 ml-md-5">
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          <h3 class="h6 position-absolute text-muted">2022.11.29</h3>
          <span
            class="rounded-circle p-1 position-absolute bg-white text-center font-weight-bold"
            >·</span
          >
          <dl class="mb-0">
            <dt><h4 class="h5">科佑新创扫号助手特供版(专属) 0.2.0 更新日志</h4></dt>
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          <h3 class="h6 position-absolute text-muted">2022.10.31</h3>
          <span
            class="rounded-circle p-1 position-absolute bg-white text-center font-weight-bold"
            >·</span
          >
          <dl class="mb-0">
            <dt><h4 class="h5">科佑新创扫号助手特供版(专属) 0.1.9 更新日志</h4></dt>
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                <p>1.修复预约页面申请主体拉取失败；</p>
              </div>
            </dd>
          </dl>
        </li>
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          <h3 class="h6 position-absolute text-muted">2022.10.18</h3>
          <span
            class="rounded-circle p-1 position-absolute bg-white text-center font-weight-bold"
            >·</span
          >
          <dl class="mb-0">
            ...
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                <p>1.增加查询预约历史功能；</p>
                <p>2.修复快审页面登录信息错误，login key要动态获取；</p>
                <p>3.修复mac系统下的一些bug；</p>
                <p>4.支持导出专利；</p>
                <p>5.修复企业账号登录时申请主体的拉取；</p>
                <p>6.修复授权问题；</p>
              </div>
            </dd>
          </dl>
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          ...
          >
          <dl class="mb-0">
            <dt><h4 class="h5">科佑新创扫号助手特供版(专属) 0.1.5 更新日志</h4></dt>
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                <p>1.省局提交预约增加验证码，批量破解验证码；</p>
                <p>2.其他一些优化；</p>
              </div>
            </dd>
          </dl>
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          ...
          >
          <dl class="mb-0">
            <dt><h4 class="h5">科佑新创扫号助手特供版(专属) 0.1.4 更新日志</h4></dt>
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                <p>1.预约成功时的日志补充以及提示；</p>
                <p>2.顺序执行优化；</p>
                <p>3.终止任务的同时中断所有请求；</p>
              </div>
            </dd>
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          ...
          >
          <dl class="mb-0">
            <dt><h4 class="h5">科佑新创扫号助手特供版(专属) 0.1.2 更新日志</h4></dt>
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                <p>1.删除ip限定；</p>
              </div>
          ...
          <dl class="mb-0">
            ...
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                ...
                <p>2.ip白名单校验；</p>
                <p>3.去掉ssl验证，应对省局证书失效；</p>
              </div>
            </dd>
          </dl>
        </li>
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          <h3 class="h6 position-absolute text-muted">2022.9.9</h3>
          <span
            class="rounded-circle p-1 position-absolute bg-white text-center font-weight-bold"
            >·</span
          >
          <dl class="mb-0">
            ...
            <dd class="card p-3 mb-0 mt-3 bg-light oya met-scrollbar">
              <div class="met-editor font-size-14 text-muted">
                ...
                <p>2.修复任务过程中，code未返回0时指针未进行移动的bug；</p>
              </div>
            </dd>
          </dl>
        </li>
        ...
        <li class="position-relative pl-3 pl-md-4 py-3 py-md-4">
          <h3 class="h6 position-absolute text-muted">2022.9,5</h3>
          <span
            class="rounded-circle p-1 position-absolute bg-white text-center font-weight-bold"
            >·</span
          >
    ...
    <el-button class="back-home" type="success" @click="backHome"
      >返回</el-button
    >
  </div>
</template>
...
ul, li, p, div, span,h1, h2, h3, h4, dl, dd, dt {
  margin: 0;
  padding: 0;
}
.changelog {
